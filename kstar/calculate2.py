    ...
    def calculate_random_activities(self, logger, num_random_experiments=150, save_experiments = False, PROCESSES = 1):
        ...
        if PROCESSES > 1:
            ...
            if save_experiments:
                ...
                self.random_activities = activities_list
...
def randomized_analysis(kinact_dict, log, num_random_experiments=150, save_experiments = False, PROCESSES = 1):
    ...
    for phospho_type, kinact in kinact_dict.items():
        kinact.calculate_random_activities(log, num_random_experiments, save_experiments = save_experiments,PROCESSES = PROCESSES)

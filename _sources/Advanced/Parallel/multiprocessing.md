...
kinact_dict = calculate.enrichment_analysis(experiment, activity_log, networks, PROCESSES = 4)

# Normalization
calculate.randomized_analysis(kinact_dict, activity_log, num_random_experiments, target_alpha, PROCESSES = 4)
